...
const AdminCalendarView = () => {
  ...
  const getCourtOrientationClasses = (orientation?: string, verticalAlignment?: string) => {
    if (orientation === 'vertical') {
      const alignmentClass = verticalAlignment === 'right' ? 'justify-end' : 'justify-start';
      return `aspect-[9/20] flex flex-col ${alignmentClass}`;
    }
                ...
                {courts.map((court) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`border border-dashed border-border p-3 rounded-md ${getCourtOrientationClasses(court.orientation, court.verticalAlignment)}`}>
